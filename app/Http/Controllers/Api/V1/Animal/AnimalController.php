...
class AnimalController extends Controller
{
    ...
    /**
     * @OA\Get(
     *      path="/api/v1/animals",        (請求 API 路徑)
     *      operationId="animalIndex",     (設定 API 功能唯一識別路徑)
     *      tags={"Animal"},               (API 分組標籤)
     *      summary="取得動物資源列表",     (簡短摘要)
     *      description="查看動物資源列表", (敘述)
     *      security={                     (設定需要身分驗證)
     *         {
     *              "passport": {}         (使用 passport 驗證)
     *         }
     *      },
     *      @OA\Parameter(
     *          name="filters",            (參數名稱)
